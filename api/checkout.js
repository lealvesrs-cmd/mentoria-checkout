...
export default async function handler(req, res) {
  ...
  const { name, email, cpfCnpj, billingType, creditCard, creditCardHolderInfo, installmentCount } = req.body;
  ...
  try {
    ...
    const customer = await asaasPost('/customers', { name, email, cpfCnpj });
    if (customer.errors) {
